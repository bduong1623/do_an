...
const SensorLinearHeatmap = ({ title, data, unit, min, max, thresholdType, createdAts, displayCount, fieldKey }) => {
  ...
  // Lấy 15 data cuối cùng
  const displayData = data.slice(-15);
  const displayCreatedAts = createdAts.slice(-15);
  ...
  return (
    <div style={{
      ...
      <div style={{
        display: 'grid',
        gridTemplateColumns: `repeat(${Math.min(15, 20)}, 1fr)`,
        gap: '2px',
        marginBottom: '12px'
      }}>
          ...
          return (
            ...
            >
              ...
              <div style={{
                ...
                {new Date(displayCreatedAts[index]).toLocaleTimeString('vi-VN')}
              </div>
            </div>
          );
        })}
